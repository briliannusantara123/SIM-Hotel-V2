...
class ReservationdiaryController extends Controller
{
   ...
   public function create (){
      $reservationdiary = Reservationdiary::all();
     return view('reservationdiary.create',['reservationdiary' => $reservationdiary])->with('success','data berhasil disimpan');
   }
   public function stores(Request $request)
   {
        ...
        return redirect('/reservationdiary')->with('success','Data anda berhasil disimpan'); 
   }
}
