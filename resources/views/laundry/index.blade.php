   ...
   <div class="main">
                  ...
                  <div class="section-body">
                    <div class="row">
                      <div class="col-12 col-md-6 col-lg-6">
                          <a href="laundry/create" class="btn btn-info">Tambah Data Laundry</a>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="konfirmasi-modal" data-backdrop="false">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p><b>Jika menghapus data laundry maka</b></p>
                    <p>*data  laundry tersebut hilang selamanya, apakah anda yakin?</p>
                </div>
    ...
    <script>
        ...
        $('#tombol-tambah').click(function () {
            ...
            $('#modal-judul').html("Tambah Data Laundry Baru"); //valuenya tambah Tipe Kamar baru
            ...
            $("#form-tambah-edit").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('laundry.store') }}", //url simpan data
        ...
        $('body').on('click', '.edit-post', function () {
            ...
            $.get('laundry/' + data_id + '/edit', function (data) {
        ...
        $('#tombol-hapus').click(function () {
            $.ajax({
                ...
                url: "laundry/" + dataId, //eksekusi ajax ke url ini
                type: 'delete',
                beforeSend: function () {
